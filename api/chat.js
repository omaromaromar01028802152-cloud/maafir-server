module.exports = async (req, res) => {
  ...
  try {
    ...
    // قراءة المفتاح بأمان من إعدادات Vercel أو استخدام المفتاح مباشرة بعد تعديل الحرف
    const GROQ_API_KEY = process.env.GROQ_API_KEY || "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";
